...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DE66wWYF.mjs");
...
var manifest = { "b32cb844387607479c01b5aee189be7b79c9c375a2ab2c51d11d96584a0502f1": {
	functionName: "getSmithStatus_createServerFn_handler",
	importer: () => import("./smith-status-BugOnSGn.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-4xYrrImm.mjs").then((n) => n.t),
