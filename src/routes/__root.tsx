  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "Bedrock-only addon smith. Forge behavior packs, resource packs, items, mobs, and Script API — nothing else.",
      },
        ...
        <AuthProvider>
          ...
          <Toaster
            ...
            toastOptions={{
              classNames: {
                toast:
                  "bg-elevated text-fg border border-border font-sans shadow-none",
                title: "text-fg",
